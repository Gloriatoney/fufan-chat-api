...
# set LLM path
MODEL_PATH = os.environ.get('MODEL_PATH', '/home/00_rag/model/ZhipuAI/chatglm3-6b')
TOKENIZER_PATH = os.environ.get("TOKENIZER_PATH", MODEL_PATH)

# set Embedding Model path
EMBEDDING_PATH = os.environ.get('EMBEDDING_PATH', '/home/00_rag/model/AI-ModelScope/bge-large-zh-v1___5')
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host='192.168.110.131', port=9091, workers=1)
